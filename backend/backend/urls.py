...
urlpatterns = [
    ...
    # this is for product {path('api/products/', include('user.urls.product_urls')),}
    path('api/', include('user.urls.product_urls')),
    path('api/users/', include('user.urls.user_urls')),
    path('api/orders/', include('user.urls.order_urls')),
